...
//    NSLog(@"there are %i views not", viewList.getNumViews());
...
//        for(int i=0;i<4;i++){
//            for(int j=0;j<4;j++){
//                //                [s appendString:[NSString stringWithFormat:@"%f ", rawProjectionMatrixGL.data[i*4+j]]];'
//                NSLog(@"%f",projectionMatrix.data[i*4+j]);
//            }
//        }
